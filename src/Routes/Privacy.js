...
const MojitoPrivacy = () => {
  return (
    <>
      <Helmet title="Privacy Policy"></Helmet>
      <Container>
        <Box>
          <Header>
            <Bigger>모지또</Bigger>
          ...
          <Contents>
            Team Blender는 개인정보보호법에 따라 이용자의 개인정보 보호 및
          ...
          <Contents>○ 본 방침은부터 2020년 12월 8일부터 시행됩니다.</Contents>
          ...
          <Contents>
            ...
            <p>
              ...
              부정이용 방지, 각종 고지·통지, 고충처리, 분쟁 조정을 위한 기록
          ...
          <Contents>
            ① 개인정보 파일명 : 모지또개인정보처리방침
            <p>
              개인정보 항목 : 이메일, 비밀번호, 서비스 이용 기록, 접속 로그,
              쿠키, 접속 IP 정보, 결제기록
            </p>
            <p>수집방법 : 홈페이지</p>
            <p>보유근거 : 정보 주체의 동의</p>
          ...
          <Title>4. 정보주체와 법정대리인의 권리·의무 및 그 행사방법</Title>
          <Contents>
            이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.
            <Margin></Margin>
            <p>
              ① 정보주체는 블렌더에 대해 언제든지 개인정보
            ...
            <p>
              ...
              수 있으며 블렌더는 이에 대해 지체 없이 조치하겠습니다.
            </p>
            <Margin></Margin>
            <p>
          ...
          <Contents>
            Team Blender는 원칙적으로 개인정보 처리목적이 달성된 경우에는
          ...
          <Contents>
            ① 블렌더는 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
            ...
            <p>
              ...
              제공을 위해 사용됩니다. 나. 쿠키의 설치•운영 및 거부 : 웹브라우저
              상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키
              저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형
          ...
          <Title>10. 개인정보의 안전성 확보 조치</Title>
          <Contents>
            Team Blender는 개인정보보호법 제29조에 따라 다음과 같이 안전성
            ...
            <p>
              블렌더는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및
